...
func LoginStaffHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LoginStaffReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := staff.NewLoginStaffLogic(r.Context(), svcCtx)
		resp, err := l.LoginStaff(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
